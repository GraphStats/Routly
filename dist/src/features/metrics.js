...
class Metrics {
     ...
     * Record a request
     */
    recordRequest(method, path, status, responseTime, error) {
        this.requestCount++;
        // By method
...
function metricsMiddleware() {
    return async (req, res, next) => {
        ...
        res.end = function (chunk, encoding, callback) {
            ...
            globalMetrics.recordRequest(req.method || 'GET', path, res.statusCode, responseTime);
 ...
 */
function metricsHandler(format = 'json') {
    return (req, res) => {
