...
function throttle(options = {}) {
    ...
    maxRequests = 100, keyGenerator = (req) => req.ip || 'unknown', skipSuccessfulRequests = false, skipFailedRequests = false, handler = (req, res) => {
        res.status(429).json({
    ...
    return async (req, res, next) => {
        ...
        res.end = function (chunk, encoding, callback) {
            if (!requestCounted) {
                ...
                const shouldCount = (!skipSuccessfulRequests || statusCode >= 400) &&
